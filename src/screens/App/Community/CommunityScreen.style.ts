...
export const HeaderContent = styled.View`
  ...
  align-items: center;
  width: 100%;
  gap: ${RFValue(8, 932)}px;
  background-color: transparent;
`;

export const HeaderTitle = styled.Text`
  color: ${whiteColor};
  font-size: ${RFValue(26, 932)}px;
  font-family: ${Montserrat700};
  line-height: ${RFValue(26, 932)}px;
`;
...
export const FloatingButton = styled.TouchableOpacity`
  position: absolute;
  bottom: ${RFValue(24, 932)}px;
  right: ${RFValue(24, 932)}px;
...
export const LoadingContainer = styled.View`
  padding: ${RFValue(20, 932)}px;
  align-items: center;
  justify-content: center;
`;

export const EmptyContainer = styled.View`
  padding: ${RFValue(40, 932)}px ${RFValue(20, 932)}px;
  align-items: center;
  justify-content: center;
`;
...
export const StickyTabBarContainer = styled(Animated.View)`
  position: absolute;
  top: ${RFValue(60, 932)}px;
  left: 0;
  right: 0;
  z-index: 5;
  background-color: ${whiteColor};
...
export const TabItem = styled.TouchableOpacity<{ isActive: boolean }>`
  flex: 1;
  padding: ${RFValue(16, 932)}px ${RFValue(12, 932)}px;
  align-items: center;
...
export const AboutSection = styled.View`
  margin-bottom: ${RFValue(20, 932)}px;
`;
...
export const AboutTitle = styled.Text`
  ...
  color: ${blackColor};
  margin-bottom: ${RFValue(8, 932)}px;
`;
...
export const IdolItem = styled.View`
  align-items: center;
  width: ${RFValue(80, 932)}px;
`;

export const IdolAvatar = styled.Image`
  width: ${RFValue(60, 932)}px;
  height: ${RFValue(60, 932)}px;
  border-radius: ${RFValue(30, 932)}px;
  margin-bottom: ${RFValue(8, 932)}px;
